...
export default function AddTable() {
    ...
    async function handleDBSchemaDownload(event) {
        ...
        const url = `http://localhost:6969/querydatabase/${database}&expand=true&apikey=${storedApiKey}`;
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const url = `http://localhost:6969/createtable/${database}&table=${tableName}&gps=${gpsval}&apikey=${storedApiKey}`;
        console.log(url);
